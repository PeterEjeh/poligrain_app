  ...
  Widget _buildPage(OnboardingPage page) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        final titleFontSize = constraints.maxHeight * 0.08; // 8% of screen height
        final subtitleFontSize = constraints.maxHeight * 0.02; // 2% of screen height
                ...
                child: Column(
                  ...
                  children: [
                    if (_currentPage == 0) ...[
                      ...
                      SizedBox(height: constraints.maxHeight * 0.03), // 3% spacing
                    ],
