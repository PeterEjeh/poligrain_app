              ...
              children: <Widget>[
                ...
                if (_errorMessage != null && _errorMessage!.isNotEmpty)
                  Padding(
                    ...
                    child: Text(
                      ...
                      textAlign: TextAlign.center,
                      style: TextStyle(
                          color: _errorMessage!.contains("code has been sent") || _errorMessage!.contains("confirmation code was sent")
                              ? Colors.green.shade700 // Green for success/info messages
                  ...
                  TextFormField(
                    ...
                    decoration: InputDecoration(
                      ...
                      enabledBorder: OutlineInputBorder(
                        borderRadius: BorderRadius.circular(8),
                        borderSide: BorderSide(
                          color: Colors.green.shade600, // Green border when enabled
                          width: 1.5,
                        ),
                      ),
                      focusedBorder: OutlineInputBorder(
                        borderRadius: BorderRadius.circular(8),
                        borderSide: BorderSide(
                          color: Colors.green.shade800, // Darker green when focused
                          width: 2.0,
                        ),
                      ),
                ...
                if (_emailSent)
                  TextFormField(
                    ...
                    validator: (value) {
                      ...
                      if (value.length < 6) { // Typical Cognito code length
                ...
                ElevatedButton(
                  onPressed: _isLoading
                      ? null
                      : (_emailSent ? _confirmEmailAndProceed : _handleContinue),
                    ...
                    child: TextButton(
                      onPressed: _isLoading ? null : () async {
                        ...
                        try {
                          ...
                          setState(() {
                            _errorMessage = "A new confirmation code has been sent.";
                          });
                        } on AuthException catch (e) {
                          setState(() {
                            _errorMessage = "Error resending code: ${e.message}";
